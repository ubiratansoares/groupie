...
```gradle
compile 'com.xwray:groupie:${latest_version}'
```
...
```gradle
compile 'com.xwray:groupie:${latest_version}'
compile 'com.xwray:groupie-kotlin-android-extensions:${latest_version}'
```
...
```gradle
compile 'com.xwray:groupie:${latest_version}'
compile 'com.xwray:groupie-databinding:${latest_version}' 
```
...
dependencies {
    implementation 'com.xwray:groupie:${latest_version}'
    implementation 'com.xwray:groupie-kotlin-android-extensions:${latest_version}'
}
```
